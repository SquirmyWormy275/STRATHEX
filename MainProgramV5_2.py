        ...
        if choice == "1":
            ...
            try:
                ...
                if new_indices:
                    ...
                    tournament_state["all_competitors_df"] = comp_df[
                        comp_df["competitor_name"].isin(current_competitors)
                    ].copy()
...
def single_event_menu():
    ...
    while True:
        ...
        if menu_choice == "1":
            ...
            if tournament_state.get("format") == "bracket":
                bracket_generated = tournament_state.get("rounds") or tournament_state.get("winners_rounds")
            ...
            if show_analysis == "y":
                try:
                    display_comprehensive_prediction_analysis(tournament_state["handicap_results_all"], wood_selection)
                except Exception as e:
            ...
            if approval_choice == "2":
                ...
                adjusted_results, initials, timestamp = manual_adjust_handicaps(
                    tournament_state["handicap_results_all"], wood_selection
                )
            ...
            len(tournament_state["all_competitors"])
            ...
            if tournament_state.get("format") == "single_heat":
                ...
                print(f"\n{'=' * 70}")
                print("  SINGLE HEAT - TRAINING/TESTING MODE")
                print(f"{'=' * 70}")
            ...
            if tournament_state.get("format") == "bracket":
                ...
                from woodchopping.ui.bracket_ui import (
                    ...
                    render_double_elim_bracket_ascii,
                )
            ...
            all_advancers = fill_advancers_with_random_draw(
                current_rounds, all_advancers, target_count, round_label=next_type
            )
            ...
            if tournament_state.get("format") == "bracket":
                ...
                print("[OK] Opened in browser automatically")
                input("\nPress Enter to return to menu...")
                continue
...
def multi_event_tournament_menu():
    ...
    while True:
        ...
        if menu_choice == "1":
            ...
            while True:
                ...
                if event_choice == "1":
                    ...
                    if not multi_event_tournament_state.get("events"):
                        ...
                        multi_event_tournament_state = remove_event_from_tournament(multi_event_tournament_state)
                elif event_choice == "3":
                    if not multi_event_tournament_state.get("events"):
            ...
            multi_event_tournament_state = assign_competitors_to_events(multi_event_tournament_state)
            ...
            multi_event_tournament_state = manage_tournament_scratches(multi_event_tournament_state)
